...
exports['default'] = _react2['default'].createClass({
  ...
  renderPagination: function renderPagination() {
    ...
    for (var i = 0; i < this.state.total; i++) {
      dots.push(i === this.state.index ? this.props.activeDot || _react2['default'].createElement(_reactNative.View, { style: {
          ...
          marginTop: 3,
          marginBottom: 3
        } }) : this.props.dot || _react2['default'].createElement(_reactNative.View, { style: {
