...
| dot              | `<View style={{backgroundColor:'rgba(0,0,0,.2)', width: 8, height: 8,borderRadius: 4, marginLeft: 3, marginRight: 3, marginTop: 3, marginBottom: 3,}} />` | `element`  | Customize the dot element.               |
| activeDot        | `<View style={{backgroundColor: '#007aff', width: 8, height: 8, borderRadius: 4, marginLeft: 3, marginRight: 3, marginTop: 3, marginBottom: 3,}} />` | `element`  | Customize the active-dot element.        |
| dotStyle         |                    -                     |  `object`  | Customize the active-dot element.        |
| dotColor         |            `'rgba(0,0,0,.2)'`            |  `string`  | Customize the active-dot element.        |
| activeDotColor   |               `'#007aff'`                |  `string`  | Customize the active-dot element.        |
| activeDotStyle   |                    -                     |  `object`  | Customize the active-dot element.        |
...
| nextButton         | `<Text style={styles.buttonText}>›</Text>` | `element` | Customize the next button.               |
| prevButton         | `<Text style={styles.buttonText}>‹</Text>` | `element` | Customize the prev button.               |
| buttonColor        |               `'#007aff'`                | `string`  | Customize the buttons color.             |
